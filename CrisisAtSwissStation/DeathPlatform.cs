...
{
    [Serializable]
    public class DeathPlatform : BoxObject
    {
        ...
        public DeathPlatform(World world, string mytexturename, string objectTexturename, int sprWidth, int sprHeight, int animInt, int myNumFrames)
