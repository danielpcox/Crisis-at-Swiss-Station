...
{
    [Serializable]
    public class WinDoorObject : BoxObject
    {
        ...
        public WinDoorObject(World world, string animTexturename, string objectTextureName, int sprWidth, int sprHeight, int animInt, int myNumFrames)
